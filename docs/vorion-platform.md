...
[Platform](https://vorion.org) · [Documentation](https://basis.vorion.org) · [API](https://basis.vorion.org/spec/overview)
...
- **Asymmetric dynamics:** Trust loss is 3x-10x faster than trust gain (P(T)=3+T)
...
```typescript
import { VorionPlatform } from '@vorionsys/sdk';
...
```typescript
import { createGateway } from '@vorionsys/atsf-core/cognigate';
...
- **Free Trial**: [Book a Demo](https://calendly.com/ryan-vorion)
- **Documentation**: [basis.vorion.org](https://basis.vorion.org)
- **API Reference**: [basis.vorion.org/spec/overview](https://basis.vorion.org/spec/overview)
